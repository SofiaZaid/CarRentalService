...
namespace CarRental.BusinessLogic
{
    public class APIMethods
    {
        ...
        public Car PickUpCar(int bookingId)
        {
            ...
            {
                EntityNotFoundFault fault = new EntityNotFoundFault();
                fault.Message = booking.ToString();
                fault.Description = "Error! Either there is no active booking for the given booking id " +
        ...
        public Car DropOffCar(int bookingId)
        {
            ...
            Booking booking = repos.DataSet<Booking>()
                ...
                && book.EndTime >= DateTime.Today.Date
            ...
            if(null == booking)
            {
                throw new FaultException("There is no active booking for the given booking id. If there is a car to return, please review input booking id " +
        ...
        public void DeleteBooking(int bookingId)
        {
            ...
            {
                EntityNotFoundFault fault = new EntityNotFoundFault();
                fault.Message = "Error when trying to fetch booking.";
                fault.Description = "Booking with that id is not found in database, please review input id.";
                throw new FaultException<EntityNotFoundFault>(fault);
            }
        }
